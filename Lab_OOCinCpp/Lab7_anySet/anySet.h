 ...
 */
#ifndef ANYSET_ANYSET_H
#define ANYSET_ANYSET_H
...
class tSet {
    public:
        /**exception class**/
        class bad_anySet : public std::exception {
            public:
                int errnum;
                explicit bad_anySet(int code) { errnum = code; }
        };
    private:
        int _capacity;
...
typedef tSet<TelephoneNumber> anySet;


#endif //ANYSET_ANYSET_H
